...
const cylinder_shadow = new THREE.MeshBasicMaterial({ map: loader.load('res/cylinder_shadow.png'), transparent: true, alphaTest: 0.01 });
const desk_shadow = new THREE.MeshBasicMaterial({ map: loader.load('res/desk_shadow.png'), transparent: true, alphaTest: 0.01 });
const shadow = new THREE.MeshBasicMaterial({ map: loader.load('res/shadow.png'), transparent: true, alphaTest: 0.01 });
const grayMaterial = new THREE.MeshLambertMaterial({ map: loader.load('res/gray.png') });
const numberMaterial = new THREE.MeshLambertMaterial({ map: loader.load('res/number.png'), alphaTest: 0.6 });

// const REPORTERTIMEOUT = 60001;

export { COLORS, BOTTLE, PARTICLE, GAME, WAVE, CAMERA, AUDIO, BLOCK, FRUSTUMSIZE, loader, cylinder_shadow, desk_shadow, shadow, grayMaterial, numberMaterial };
